...
HD_PWD='D:/Counter/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_counter.tcl -notrace
