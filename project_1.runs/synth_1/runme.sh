...
HD_PWD='D:/Counter/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_counter.tcl
